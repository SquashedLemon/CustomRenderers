...
#pragma warning disable CS0618 // Type or member is obsolete
    public class CustomSliderRenderer : ViewRenderer<CustomSlider, VerticalSlider>
    {
        VerticalSlider UIVerticalSlider;

        protected override void OnElementChanged(ElementChangedEventArgs<CustomSlider> _E)
        {
